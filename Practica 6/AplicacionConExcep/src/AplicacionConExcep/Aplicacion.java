 ...
 * misma forma que su clase base 'AplicacionBasica' a la que se ha añadido la
 * funcionalidad necesaria para realizar la composición de aplicaciones.
 */
public class Aplicacion extends AplicacionBasica {
    ...
    public Aplicacion(Aplicacion x) {
        super(x);
    }

    public Aplicacion(int[] x) throws AplicacionBasicaException {
        super(x);
    }
    ...
    public static Aplicacion componer(Aplicacion f, Aplicacion g)
        ...
        }catch (AplicacionBasicaException e){  
        }             
        return null;
        }
            /**
             * Devuelve la aplicación que resulta al componer esta aplicación
             * con la referenciada por el parámetro.
             *
    ...
    /**
     * Devuelve la aplicación que resulta al componer la referenciada por el
     * parámetro con esta aplicación.
     *
     * @param f una aplicación
